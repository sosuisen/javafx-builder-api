...
/**
 * Utility class providing consistent method and constructor comparison for sorting.
...
public class MethodComparator {
    ...
    /**
     * Creates a string representation of the executable (method or constructor) signature.
