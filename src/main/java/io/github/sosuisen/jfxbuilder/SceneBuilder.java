...
public class SceneBuilder {
    ...
    public static  SceneBuilder create(Parent root, double width, double height, Paint fill) {
        SceneBuilder builder = new SceneBuilder();
        builder.constructorArgs = new Object[]{root, width, height, fill};
        return builder;
    }
    public static  SceneBuilder create(Parent root, double width, double height, boolean depthBuffer) {
        SceneBuilder builder = new SceneBuilder();
        builder.constructorArgs = new Object[]{root, width, height, depthBuffer};
        return builder;
    }
    ...
    public static  SceneBuilder create(Parent root, Paint fill) {
        SceneBuilder builder = new SceneBuilder();
        builder.constructorArgs = new Object[]{root, fill};
        return builder;
    }
    public Scene build() {
        Scene newInstance;
