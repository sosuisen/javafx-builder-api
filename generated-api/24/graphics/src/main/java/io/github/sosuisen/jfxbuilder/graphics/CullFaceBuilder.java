...
public class CullFaceBuilder {
    private java.util.List<java.util.function.Consumer<javafx.scene.shape.CullFace>> operations = new java.util.ArrayList<>();
    ...
    /**
     * Applies a function to the CullFace instance currently being constructed.
