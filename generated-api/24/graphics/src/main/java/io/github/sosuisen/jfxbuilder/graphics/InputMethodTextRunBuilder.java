...
public class InputMethodTextRunBuilder {
    ...
    /**
     * Applies a function to the InputMethodTextRun instance currently being built.
     * Most operations on the instance can be performed using this method.
     *
     * <p>Example usage:</p>     
     * <pre>{@code
     * apply(inputMethodTextRun -> inputMethodTextRun.setId("Main" + inputMethodTextRun.getTypeSelector()))
     * }</pre>
     * 
