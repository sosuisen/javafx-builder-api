...
public class TextAlignmentBuilder {
    private java.util.List<java.util.function.Consumer<javafx.scene.text.TextAlignment>> operations = new java.util.ArrayList<>();
    ...
    /**
     * Applies a function to the TextAlignment instance currently being constructed.
