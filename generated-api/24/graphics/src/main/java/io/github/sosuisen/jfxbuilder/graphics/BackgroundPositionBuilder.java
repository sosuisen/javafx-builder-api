...
public class BackgroundPositionBuilder {
    ...
    /**
     * Applies a function to the BackgroundPosition instance currently being built.
     * Most operations on the instance can be performed using this method.
     *
     * <p>Example usage:</p>     
     * <pre>{@code
     * apply(backgroundPosition -> backgroundPosition.setId("Main" + backgroundPosition.getTypeSelector()))
     * }</pre>
     * 
