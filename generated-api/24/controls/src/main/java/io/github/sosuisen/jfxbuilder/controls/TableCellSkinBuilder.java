...
public class TableCellSkinBuilder<S, T> {
    ...
    /**
     * Accepts the same arguments as {@link javafx.scene.control.skin.TableCellSkin#TableCellSkin(TableCell) TableCellSkin(TableCell)}
     * and returns an instance of the {@code TableCellSkinBuilder<S, T>}.
     *
    ...
    /**
     * Applies a function to the TableCellSkin instance currently being constructed.
