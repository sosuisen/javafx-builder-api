...
public class ButtonBarSkinBuilder {
    ...
    /**
     * Accepts the same arguments as {@link javafx.scene.control.skin.ButtonBarSkin#ButtonBarSkin(javafx.scene.control.ButtonBar control) ButtonBarSkin(ButtonBar)}
     * and returns an instance of the {@code ButtonBarSkinBuilder}.
     *
    ...
    /**
     * Applies a function to the ButtonBarSkin instance currently being constructed.
    ...
    /**
     * Call the {@link javafx.collections.ObservableList#addAll(E... elements) addAll} method on the ObservableList returned by the {@link javafx.scene.control.skin.ButtonBarSkin#getChildren()} method.
     * 
     * @return builder instance
     */
    @SafeVarargs
    ...
    /**
     * Call the {@link java.util.List#addAll(Collection<? extends E> c) addAll} method on the ObservableList returned by the {@link javafx.scene.control.skin.ButtonBarSkin#getChildren()} method.
     * 
     * @return builder instance
     */
