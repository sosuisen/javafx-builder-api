...
public class ChoiceBoxSkinBuilder<T> {
    private java.util.List<java.util.function.Consumer<javafx.scene.control.skin.ChoiceBoxSkin<T>>> operations = new java.util.ArrayList<>();
    private ChoiceBoxSkinBuilder() {}
    

    /**
     * Accepts the same arguments as {@link javafx.scene.control.skin.ChoiceBoxSkin#ChoiceBoxSkin(ChoiceBox) ChoiceBoxSkin(ChoiceBox)}
     * and returns an instance of the {@code ChoiceBoxSkinBuilder<T>}.
     *
    ...
    /**
     * Builds and returns an instance of the {@link javafx.scene.control.skin.ChoiceBoxSkin<T>} class.
     * 
     * <p>
    ...
    /**
     * Applies a function to the ChoiceBoxSkin instance currently being constructed.
    ...
    /**
     * Call the {@link javafx.collections.ObservableList#addAll(E... elements) addAll} method on the ObservableList returned by the {@link javafx.scene.control.skin.ChoiceBoxSkin#getChildren()} method.
     * 
     * @return builder instance
     */
    @SafeVarargs
    ...
    /**
     * Call the {@link java.util.List#addAll(Collection<? extends E> c) addAll} method on the ObservableList returned by the {@link javafx.scene.control.skin.ChoiceBoxSkin#getChildren()} method.
     * 
     * @return builder instance
     */
