...
public class HitInfoBuilder {
    private final java.util.List<java.util.function.Consumer<javafx.scene.text.HitInfo>> operations = new java.util.ArrayList<>();
    private HitInfoBuilder() {}
    
    private Object[] constructorArgs;

    /**
     * Builds and returns an instance of the {@link javafx.scene.text.HitInfo HitInfo} class.
     * 
     * <p>
