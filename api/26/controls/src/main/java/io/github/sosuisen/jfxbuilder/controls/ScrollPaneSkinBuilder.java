...
/**
 * The {@code ScrollPaneSkinBuilder} class constructs instances of the {@link javafx.scene.control.skin.ScrollPaneSkin ScrollPaneSkin} class 
 * and offers a fluent interface for creating and configuring it. 
 *
 * <p>
 * This class includes a static {@code create} method that accepts the same arguments as the original {@link javafx.scene.control.skin.ScrollPaneSkin ScrollPaneSkin} constructor
 * and returns an instance of the {@code ScrollPaneSkinBuilder}.
 * </p>
 *
 * <p>
 * You can use method chaining to call the builder methods for configuring the {@link javafx.scene.control.skin.ScrollPaneSkin ScrollPaneSkin}.
 * Finally, invoke the {@code build} method to generate an instance of the {@link javafx.scene.control.skin.ScrollPaneSkin ScrollPaneSkin} class.
 * </p>
 *
 * <p>
...
public class ScrollPaneSkinBuilder {
    private final java.util.List<java.util.function.Consumer<javafx.scene.control.skin.ScrollPaneSkin>> operations = new java.util.ArrayList<>();
    private ScrollPaneSkinBuilder() {}
    
    /**
     * Accepts the constructor arguments of {@link javafx.scene.control.skin.ScrollPaneSkin#ScrollPaneSkin(javafx.scene.control.ScrollPane) ScrollPaneSkin(ScrollPane)}
    ...
    /**
     * Builds and returns an instance of the {@link javafx.scene.control.skin.ScrollPaneSkin ScrollPaneSkin} class.
     * 
     * <p>
     ...
     * </p>
     *
     * @return new instance of the {@link javafx.scene.control.skin.ScrollPaneSkin ScrollPaneSkin} class
     */
