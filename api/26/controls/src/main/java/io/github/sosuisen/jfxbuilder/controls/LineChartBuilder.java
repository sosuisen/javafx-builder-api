...
public class LineChartBuilder<X, Y> {
    private final java.util.List<java.util.function.Consumer<javafx.scene.chart.LineChart<X, Y>>> operations = new java.util.ArrayList<>();
    private LineChartBuilder() {}
    
    /**
     * Accepts the constructor arguments of {@link javafx.scene.chart.LineChart#LineChart(javafx.scene.chart.Axis, javafx.scene.chart.Axis) LineChart(Axis, Axis)}
    ...
    /**
     * Accepts the constructor arguments of {@link javafx.scene.chart.LineChart#LineChart(javafx.scene.chart.Axis, javafx.scene.chart.Axis, javafx.collections.ObservableList) LineChart(Axis, Axis, ObservableList)}
     * and returns an instance of {@code LineChartBuilder<X, Y>}.
     *
     * @return an instance of the {@code LineChartBuilder<X, Y>}.
     */
     ...
     * @return builder instance
     */
    public  LineChartBuilder<X, Y> onMouseDragDone(javafx.event.EventHandler<? super javafx.scene.input.MouseDragEvent> value) {
     ...
     * @return builder instance
     */
    public LineChartBuilder<X, Y> onMouseDragDonePropertyApply(java.util.function.Consumer<javafx.beans.property.ObjectProperty<javafx.event.EventHandler<? super javafx.scene.input.MouseDragEvent>>> op) {
     ...
     * on the ObservableList returned by the {@link javafx.scene.chart.LineChart#getData() LineChart#getData()} method.
     *
     * <p>
     * After calling this method, you may need to invoke the {@link io.github.sosuisen.jfxbuilder.controls.LineChartBuilder#xAxis(javafx.scene.chart.Axis) xAxis(Axis)} and {@link io.github.sosuisen.jfxbuilder.controls.LineChartBuilder#yAxis(javafx.scene.chart.Axis) yAxis(Axis)} methods. 
     ...
     */
    @SafeVarargs
    public static <X, Y> LineChartBuilder<X, Y> withData(javafx.scene.chart.XYChart.Series<X, Y>... elements) {
        LineChartBuilder<X, Y> builder = new LineChartBuilder<X, Y>();
     ...
     * @return builder instance
     */
    public static <X, Y> LineChartBuilder<X, Y> withData(java.util.Collection<? extends javafx.scene.chart.XYChart.Series<X, Y>> col) {
        LineChartBuilder<X, Y> builder = new LineChartBuilder<X, Y>();
        builder.constructorArgs = new Object[]{new javafx.scene.chart.CategoryAxis(), new javafx.scene.chart.NumberAxis()};
    ...
    private static <X, Y> void setDefaultConstructorArgs(LineChartBuilder<X, Y> builder,
     ...
     * This method is used together with the {@link io.github.sosuisen.jfxbuilder.controls.LineChartBuilder#withData(javafx.scene.chart.XYChart.Series...) withData(Series...)} or the {@link io.github.sosuisen.jfxbuilder.controls.LineChartBuilder#withData(java.util.Collection col) withData(Collection)}.
     *
     * @return builder instance
     */
    public LineChartBuilder<X, Y> xAxis(javafx.scene.chart.Axis<X> axis) {
     ...
     * @return builder instance
     */
    public LineChartBuilder<X, Y> yAxis(javafx.scene.chart.Axis<Y> axis) {
