...
public class TreeTableViewBuilder<S> {
     ...
     * @return builder instance
     */
    public  TreeTableViewBuilder<S> onMouseDragDone(javafx.event.EventHandler<? super javafx.scene.input.MouseDragEvent> value) {
     ...
     * @return builder instance
     */
    public TreeTableViewBuilder<S> onMouseDragDonePropertyApply(java.util.function.Consumer<javafx.beans.property.ObjectProperty<javafx.event.EventHandler<? super javafx.scene.input.MouseDragEvent>>> op) {
