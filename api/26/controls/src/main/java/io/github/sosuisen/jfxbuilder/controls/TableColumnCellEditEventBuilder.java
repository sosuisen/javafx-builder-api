...
public class TableColumnCellEditEventBuilder<S, T> {
    ...
    /**
     * Accepts the constructor arguments of {@link javafx.scene.control.TableColumn.CellEditEvent#CellEditEvent(javafx.scene.control.TableView, javafx.scene.control.TablePosition, javafx.event.EventType, java.lang.Object) CellEditEvent(TableView, TablePosition, EventType, T)}
    ...
    /**
     * Builds and returns an instance of the {@link javafx.scene.control.TableColumn.CellEditEvent CellEditEvent} class.
     * 
     * <p>
