...
public class BubbleChartBuilder<X, Y> {
    ...
    /**
     * Builds and returns an instance of the {@link javafx.scene.chart.BubbleChart BubbleChart} class.
     * 
     * <p>
     ...
     * @return builder instance
     */
    public  BubbleChartBuilder<X, Y> onMouseDragDone(javafx.event.EventHandler<? super javafx.scene.input.MouseDragEvent> value) {
     ...
     * @return builder instance
     */
    public BubbleChartBuilder<X, Y> onMouseDragDonePropertyApply(java.util.function.Consumer<javafx.beans.property.ObjectProperty<javafx.event.EventHandler<? super javafx.scene.input.MouseDragEvent>>> op) {
