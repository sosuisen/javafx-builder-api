...
public class CheckBoxTreeCellBuilder<T> {
     ...
     * @return builder instance
     */
    public  CheckBoxTreeCellBuilder<T> onMouseDragDone(javafx.event.EventHandler<? super javafx.scene.input.MouseDragEvent> value) {
     ...
     * @return builder instance
     */
    public CheckBoxTreeCellBuilder<T> onMouseDragDonePropertyApply(java.util.function.Consumer<javafx.beans.property.ObjectProperty<javafx.event.EventHandler<? super javafx.scene.input.MouseDragEvent>>> op) {
