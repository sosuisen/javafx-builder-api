...
public class ChoiceBoxTreeTableCellBuilder<S, T> {
    ...
    /**
     * Builds and returns an instance of the {@link javafx.scene.control.cell.ChoiceBoxTreeTableCell ChoiceBoxTreeTableCell} class.
     * 
     * <p>
     ...
     * @return builder instance
     */
    public  ChoiceBoxTreeTableCellBuilder<S, T> onMouseDragDone(javafx.event.EventHandler<? super javafx.scene.input.MouseDragEvent> value) {
     ...
     * @return builder instance
     */
    public ChoiceBoxTreeTableCellBuilder<S, T> onMouseDragDonePropertyApply(java.util.function.Consumer<javafx.beans.property.ObjectProperty<javafx.event.EventHandler<? super javafx.scene.input.MouseDragEvent>>> op) {
