...
public class StackedBarChartBuilder<X, Y> {
     ...
     * @return builder instance
     */
    public  StackedBarChartBuilder<X, Y> onMouseDragDone(javafx.event.EventHandler<? super javafx.scene.input.MouseDragEvent> value) {
     ...
     * returned by the {@link javafx.scene.chart.XYChart#getData() StackedBarChart#getData()} method.
     * 
     * @return builder instance
     */
    @SafeVarargs
    ...
    /**
     * Calls the {@link javafx.collections.ObservableList#addAll(java.lang.Object[]) addAll} method on the ObservableList
     * returned by the {@link javafx.scene.Node#getStyleClass() StackedBarChart#getStyleClass()} method.
     * 
     * @return builder instance
     */
    ...
    /**
     * Calls the {@link javafx.collections.ObservableList#addAll(java.lang.Object[]) addAll} method on the ObservableList
     * returned by the {@link javafx.scene.Parent#getStylesheets() StackedBarChart#getStylesheets()} method.
     * 
     * @return builder instance
     */
    ...
    /**
     * Calls the {@link javafx.collections.ObservableList#addAll(java.lang.Object[]) addAll} method on the ObservableList
     * returned by the {@link javafx.scene.Node#getTransforms() StackedBarChart#getTransforms()} method.
     * 
     * @return builder instance
     */
     ...
     * @return builder instance
     */
    public StackedBarChartBuilder<X, Y> onMouseDragDonePropertyApply(java.util.function.Consumer<javafx.beans.property.ObjectProperty<javafx.event.EventHandler<? super javafx.scene.input.MouseDragEvent>>> op) {
     ...
     */
    @SafeVarargs
    public static <X, Y> StackedBarChartBuilder<X, Y> withData(javafx.scene.chart.XYChart.Series<X, Y>... elements) {
        StackedBarChartBuilder<X, Y> builder = new StackedBarChartBuilder<X, Y>();
     ...
     * @return builder instance
     */
    public static <X, Y> StackedBarChartBuilder<X, Y> withData(java.util.Collection<? extends javafx.scene.chart.XYChart.Series<X, Y>> col) {
        StackedBarChartBuilder<X, Y> builder = new StackedBarChartBuilder<X, Y>();
        builder.constructorArgs = new Object[]{new javafx.scene.chart.CategoryAxis(), new javafx.scene.chart.NumberAxis()};
    ...
    private static <X, Y> void setDefaultConstructorArgs(StackedBarChartBuilder<X, Y> builder,
     ...
     * @return builder instance
     */
    public StackedBarChartBuilder<X, Y> xAxis(javafx.scene.chart.Axis<X> axis) {
     ...
     * @return builder instance
     */
    public StackedBarChartBuilder<X, Y> yAxis(javafx.scene.chart.Axis<Y> axis) {
