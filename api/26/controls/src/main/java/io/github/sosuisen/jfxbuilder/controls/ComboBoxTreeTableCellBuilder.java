...
public class ComboBoxTreeTableCellBuilder<S, T> {
     ...
     * @return builder instance
     */
    public  ComboBoxTreeTableCellBuilder<S, T> onMouseDragDone(javafx.event.EventHandler<? super javafx.scene.input.MouseDragEvent> value) {
     ...
     * @return builder instance
     */
    public ComboBoxTreeTableCellBuilder<S, T> onMouseDragDonePropertyApply(java.util.function.Consumer<javafx.beans.property.ObjectProperty<javafx.event.EventHandler<? super javafx.scene.input.MouseDragEvent>>> op) {
