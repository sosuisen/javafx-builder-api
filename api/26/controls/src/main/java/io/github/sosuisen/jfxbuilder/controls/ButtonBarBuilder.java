...
public class ButtonBarBuilder {
    private final java.util.List<java.util.function.Consumer<javafx.scene.control.ButtonBar>> operations = new java.util.ArrayList<>();
    ...
    /**
     * Accepts the constructor arguments of {@link javafx.scene.control.ButtonBar#ButtonBar(java.lang.String) ButtonBar(String)}
     ...
     * @return builder instance
     */
    public  ButtonBarBuilder onMouseDragDone(javafx.event.EventHandler<? super javafx.scene.input.MouseDragEvent> value) {
    ...
    public final ButtonBarBuilder addButtons(javafx.scene.Node... elements) {
        operations.add(obj -> obj.getButtons().addAll(elements));
        return this;
    }
    ...
    public final ButtonBarBuilder addButtons(java.util.Collection<? extends javafx.scene.Node> col) {
        operations.add(obj -> obj.getButtons().addAll(col));
        return this;
    }
     ...
     * @return builder instance
     */
    public ButtonBarBuilder onMouseDragDonePropertyApply(java.util.function.Consumer<javafx.beans.property.ObjectProperty<javafx.event.EventHandler<? super javafx.scene.input.MouseDragEvent>>> op) {
