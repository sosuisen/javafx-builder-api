...
/**
 * The {@code LabelBuilder} class constructs instances of the {@link javafx.scene.control.Label Label} class 
 * and offers a fluent interface for creating and configuring it. 
 *
 * <p>
 * This class includes a static {@code create} method that accepts the same arguments as the original {@link javafx.scene.control.Label Label} constructor
 * and returns an instance of the {@code LabelBuilder}.
 * </p>
 *
 * <p>
 * You can use method chaining to call the builder methods for configuring the {@link javafx.scene.control.Label Label}.
 * Finally, invoke the {@code build} method to generate an instance of the {@link javafx.scene.control.Label Label} class.
 * </p>
 *
 * <p>
...
public class LabelBuilder {
    private final java.util.List<java.util.function.Consumer<javafx.scene.control.Label>> operations = new java.util.ArrayList<>();
    ...
    /**
     * Accepts the constructor arguments of {@link javafx.scene.control.Label#Label(java.lang.String) Label(String)}
    ...
    /**
     * Accepts the constructor arguments of {@link javafx.scene.control.Label#Label(java.lang.String, javafx.scene.Node) Label(String, Node)}
     * and returns an instance of {@code LabelBuilder}.
     *
     * @return an instance of the {@code LabelBuilder}.
     */
    ...
    /**
     * Builds and returns an instance of the {@link javafx.scene.control.Label Label} class.
     * 
     * <p>
     ...
     * </p>
     *
     * @return new instance of the {@link javafx.scene.control.Label Label} class
     */
     ...
     * @return builder instance
     */
    public  LabelBuilder onMouseDragDone(javafx.event.EventHandler<? super javafx.scene.input.MouseDragEvent> value) {
     ...
     * returned by the {@link javafx.scene.Node#getStyleClass() Label#getStyleClass()} method.
     * 
     * @return builder instance
     */
    ...
    /**
     * Calls the {@link javafx.collections.ObservableList#addAll(java.lang.Object[]) addAll} method on the ObservableList
     * returned by the {@link javafx.scene.Parent#getStylesheets() Label#getStylesheets()} method.
     * 
     * @return builder instance
     */
    ...
    /**
     * Calls the {@link javafx.collections.ObservableList#addAll(java.lang.Object[]) addAll} method on the ObservableList
     * returned by the {@link javafx.scene.Node#getTransforms() Label#getTransforms()} method.
     * 
     * @return builder instance
     */
     ...
     * @return builder instance
     */
    public LabelBuilder onMouseDragDonePropertyApply(java.util.function.Consumer<javafx.beans.property.ObjectProperty<javafx.event.EventHandler<? super javafx.scene.input.MouseDragEvent>>> op) {
