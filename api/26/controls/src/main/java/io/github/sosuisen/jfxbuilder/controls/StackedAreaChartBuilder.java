...
public class StackedAreaChartBuilder<X, Y> {
    private final java.util.List<java.util.function.Consumer<javafx.scene.chart.StackedAreaChart<X, Y>>> operations = new java.util.ArrayList<>();
    private StackedAreaChartBuilder() {}
    
    /**
     * Accepts the constructor arguments of {@link javafx.scene.chart.StackedAreaChart#StackedAreaChart(javafx.scene.chart.Axis, javafx.scene.chart.Axis) StackedAreaChart(Axis, Axis)}
    ...
    /**
     * Accepts the constructor arguments of {@link javafx.scene.chart.StackedAreaChart#StackedAreaChart(javafx.scene.chart.Axis, javafx.scene.chart.Axis, javafx.collections.ObservableList) StackedAreaChart(Axis, Axis, ObservableList)}
     * and returns an instance of {@code StackedAreaChartBuilder<X, Y>}.
     *
     * @return an instance of the {@code StackedAreaChartBuilder<X, Y>}.
     */
    ...
    /**
     * Builds and returns an instance of the {@link javafx.scene.chart.StackedAreaChart StackedAreaChart} class.
     * 
     * <p>
     ...
     * @return builder instance
     */
    public  StackedAreaChartBuilder<X, Y> onMouseDragDone(javafx.event.EventHandler<? super javafx.scene.input.MouseDragEvent> value) {
     ...
     * @return builder instance
     */
    public StackedAreaChartBuilder<X, Y> onMouseDragDonePropertyApply(java.util.function.Consumer<javafx.beans.property.ObjectProperty<javafx.event.EventHandler<? super javafx.scene.input.MouseDragEvent>>> op) {
     ...
     * on the ObservableList returned by the {@link javafx.scene.chart.StackedAreaChart#getData() StackedAreaChart#getData()} method.
     *
     * <p>
     * After calling this method, you may need to invoke the {@link io.github.sosuisen.jfxbuilder.controls.StackedAreaChartBuilder#xAxis(javafx.scene.chart.Axis) xAxis(Axis)} and {@link io.github.sosuisen.jfxbuilder.controls.StackedAreaChartBuilder#yAxis(javafx.scene.chart.Axis) yAxis(Axis)} methods. 
     ...
     */
    @SafeVarargs
    public static <X, Y> StackedAreaChartBuilder<X, Y> withData(javafx.scene.chart.XYChart.Series<X, Y>... elements) {
        StackedAreaChartBuilder<X, Y> builder = new StackedAreaChartBuilder<X, Y>();
     ...
     * @return builder instance
     */
    public static <X, Y> StackedAreaChartBuilder<X, Y> withData(java.util.Collection<? extends javafx.scene.chart.XYChart.Series<X, Y>> col) {
        StackedAreaChartBuilder<X, Y> builder = new StackedAreaChartBuilder<X, Y>();
        builder.constructorArgs = new Object[]{new javafx.scene.chart.CategoryAxis(), new javafx.scene.chart.NumberAxis()};
    ...
    private static <X, Y> void setDefaultConstructorArgs(StackedAreaChartBuilder<X, Y> builder,
     ...
     * This method is used together with the {@link io.github.sosuisen.jfxbuilder.controls.StackedAreaChartBuilder#withData(javafx.scene.chart.XYChart.Series...) withData(Series...)} or the {@link io.github.sosuisen.jfxbuilder.controls.StackedAreaChartBuilder#withData(java.util.Collection col) withData(Collection)}.
     *
     * @return builder instance
     */
    public StackedAreaChartBuilder<X, Y> xAxis(javafx.scene.chart.Axis<X> axis) {
     ...
     * @return builder instance
     */
    public StackedAreaChartBuilder<X, Y> yAxis(javafx.scene.chart.Axis<Y> axis) {
