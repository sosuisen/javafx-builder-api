...
/**
 * The {@code ColorPickerSkinBuilder} class constructs instances of the {@link javafx.scene.control.skin.ColorPickerSkin ColorPickerSkin} class 
 * and offers a fluent interface for creating and configuring it. 
 *
 * <p>
 * This class includes a static {@code create} method that accepts the same arguments as the original {@link javafx.scene.control.skin.ColorPickerSkin ColorPickerSkin} constructor
 * and returns an instance of the {@code ColorPickerSkinBuilder}.
 * </p>
 *
 * <p>
 * You can use method chaining to call the builder methods for configuring the {@link javafx.scene.control.skin.ColorPickerSkin ColorPickerSkin}.
 * Finally, invoke the {@code build} method to generate an instance of the {@link javafx.scene.control.skin.ColorPickerSkin ColorPickerSkin} class.
 * </p>
 *
 * <p>
...
public class ColorPickerSkinBuilder {
    ...
    /**
     * Builds and returns an instance of the {@link javafx.scene.control.skin.ColorPickerSkin ColorPickerSkin} class.
     * 
     * <p>
     ...
     * </p>
     *
     * @return new instance of the {@link javafx.scene.control.skin.ColorPickerSkin ColorPickerSkin} class
     */
    public javafx.scene.control.skin.ColorPickerSkin build() {
        javafx.scene.control.skin.ColorPickerSkin newInstance;

        newInstance = callParameterizedConstructor();


        for (java.util.function.Consumer<javafx.scene.control.skin.ColorPickerSkin> op : operations) {
    ...
    private javafx.scene.control.skin.ColorPickerSkin callParameterizedConstructor() {
        javafx.scene.control.skin.ColorPickerSkin newInstance;        
        try {
            java.lang.reflect.Constructor<?>[] constructors = javafx.scene.control.skin.ColorPickerSkin.class.getConstructors();
            newInstance = null;
            for (java.lang.reflect.Constructor<?> constructor : constructors) {
                if (constructor.getParameterCount() == constructorArgs.length && isConstructorCompatible(constructor, constructorArgs)) {
                    newInstance = (javafx.scene.control.skin.ColorPickerSkin) constructor.newInstance(constructorArgs);
                    break;
                }
            }
            if (newInstance == null) {
     ...
     * returned by the {@link javafx.scene.control.SkinBase#getChildren() ColorPickerSkin#getChildren()} method.
     * 
     * @return builder instance
     */
