...
public class VirtualFlowBuilder<T extends javafx.scene.control.IndexedCell> {
    private final java.util.List<java.util.function.Consumer<javafx.scene.control.skin.VirtualFlow<T>>> operations = new java.util.ArrayList<>();
     ...
     * @return builder instance
     */
    public  VirtualFlowBuilder<T> onMouseDragDone(javafx.event.EventHandler<? super javafx.scene.input.MouseDragEvent> value) {
     ...
     * @return builder instance
     */
    public VirtualFlowBuilder<T> onMouseDragDonePropertyApply(java.util.function.Consumer<javafx.beans.property.ObjectProperty<javafx.event.EventHandler<? super javafx.scene.input.MouseDragEvent>>> op) {
