...
public class PolygonBuilder {
    private final java.util.List<java.util.function.Consumer<javafx.scene.shape.Polygon>> operations = new java.util.ArrayList<>();
     ...
     * @return builder instance
     */
    public  PolygonBuilder onMouseDragDone(javafx.event.EventHandler<? super javafx.scene.input.MouseDragEvent> value) {
    ...
    public final PolygonBuilder addPoints(java.lang.Double... elements) {
        operations.add(obj -> obj.getPoints().addAll(elements));
        return this;
    }
    ...
    public final PolygonBuilder addPoints(java.util.Collection<? extends java.lang.Double> col) {
        operations.add(obj -> obj.getPoints().addAll(col));
        return this;
    }
     ...
     * @return builder instance
     */
    public PolygonBuilder onMouseDragDonePropertyApply(java.util.function.Consumer<javafx.beans.property.ObjectProperty<javafx.event.EventHandler<? super javafx.scene.input.MouseDragEvent>>> op) {
