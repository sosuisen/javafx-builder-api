...
public class ArcBuilder {
    private final java.util.List<java.util.function.Consumer<javafx.scene.shape.Arc>> operations = new java.util.ArrayList<>();
    private ArcBuilder() {}
    ...
    /**
     * Builds and returns an instance of the {@link javafx.scene.shape.Arc Arc} class.
     * 
     * <p>
     ...
     * @return builder instance
     */
    public  ArcBuilder onMouseDragDone(javafx.event.EventHandler<? super javafx.scene.input.MouseDragEvent> value) {
     ...
     * @return builder instance
     */
    public ArcBuilder onMouseDragDonePropertyApply(java.util.function.Consumer<javafx.beans.property.ObjectProperty<javafx.event.EventHandler<? super javafx.scene.input.MouseDragEvent>>> op) {
