...
/**
 * The {@code ImageBuilder} class constructs instances of the {@link javafx.scene.image.Image Image} class 
 * and offers a fluent interface for creating and configuring it. 
 *
 * <p>
 * This class includes a static {@code create} method that accepts the same arguments as the original {@link javafx.scene.image.Image Image} constructor
 * and returns an instance of the {@code ImageBuilder}.
 * </p>
 *
 * <p>
 * You can use method chaining to call the builder methods for configuring the {@link javafx.scene.image.Image Image}.
 * Finally, invoke the {@code build} method to generate an instance of the {@link javafx.scene.image.Image Image} class.
 * </p>
 *
 * <p>
...
public class ImageBuilder {
    ...
    /**
     * Accepts the constructor arguments of {@link javafx.scene.image.Image#Image(java.io.InputStream, boolean) Image(InputStream, boolean)}
     * and returns an instance of {@code ImageBuilder}.
     *
     * @return an instance of the {@code ImageBuilder}.
     */
    public static ImageBuilder create(java.io.InputStream is, boolean backgroundLoading) {
        ImageBuilder builder = new ImageBuilder();
        builder.constructorArgs = new Object[]{is, backgroundLoading};
        return builder;
    }
    ...
    /**
     * Accepts the constructor arguments of {@link javafx.scene.image.Image#Image(java.io.InputStream, double, double, boolean, boolean, boolean) Image(InputStream, double, double, boolean, boolean, boolean)}
     * and returns an instance of {@code ImageBuilder}.
     *
     * @return an instance of the {@code ImageBuilder}.
     */
    public static ImageBuilder create(java.io.InputStream is, double requestedWidth, double requestedHeight, boolean preserveRatio, boolean smooth, boolean backgroundLoading) {
        ImageBuilder builder = new ImageBuilder();
        builder.constructorArgs = new Object[]{is, requestedWidth, requestedHeight, preserveRatio, smooth, backgroundLoading};
        return builder;
    }
     ...
     * This serves as a shorthand form of the {@link ImageBuilder#apply(java.util.function.Consumer) apply} method.
     * <p>
     * Example: 
     * </p>
     * {@snippet :
