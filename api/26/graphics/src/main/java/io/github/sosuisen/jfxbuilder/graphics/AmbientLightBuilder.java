...
public class AmbientLightBuilder {
    private final java.util.List<java.util.function.Consumer<javafx.scene.AmbientLight>> operations = new java.util.ArrayList<>();
    ...
    /**
     * Accepts the constructor arguments of {@link javafx.scene.AmbientLight#AmbientLight(javafx.scene.paint.Color) AmbientLight(Color)}
    ...
    /**
     * Builds and returns an instance of the {@link javafx.scene.AmbientLight AmbientLight} class.
     * 
     * <p>
     ...
     * @return builder instance
     */
    public  AmbientLightBuilder onMouseDragDone(javafx.event.EventHandler<? super javafx.scene.input.MouseDragEvent> value) {
     ...
     * @return builder instance
     */
    public AmbientLightBuilder onMouseDragDonePropertyApply(java.util.function.Consumer<javafx.beans.property.ObjectProperty<javafx.event.EventHandler<? super javafx.scene.input.MouseDragEvent>>> op) {
