...
/**
 * The {@code SnapshotParametersBuilder} class constructs instances of the {@link javafx.scene.SnapshotParameters SnapshotParameters} class 
 * and offers a fluent interface for creating and configuring it. 
 *
 * <p>
 * This class includes a static {@code create} method that accepts the same arguments as the original {@link javafx.scene.SnapshotParameters SnapshotParameters} constructor
 * and returns an instance of the {@code SnapshotParametersBuilder}.
 * </p>
 *
 * <p>
 * You can use method chaining to call the builder methods for configuring the {@link javafx.scene.SnapshotParameters SnapshotParameters}.
 * Finally, invoke the {@code build} method to generate an instance of the {@link javafx.scene.SnapshotParameters SnapshotParameters} class.
 * </p>
 *
 * <p>
...
public class SnapshotParametersBuilder {
    private final java.util.List<java.util.function.Consumer<javafx.scene.SnapshotParameters>> operations = new java.util.ArrayList<>();
    ...
    /**
     * Builds and returns an instance of the {@link javafx.scene.SnapshotParameters SnapshotParameters} class.
     * 
     * <p>
