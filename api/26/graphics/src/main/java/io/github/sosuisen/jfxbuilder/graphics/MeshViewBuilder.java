...
public class MeshViewBuilder {
    private final java.util.List<java.util.function.Consumer<javafx.scene.shape.MeshView>> operations = new java.util.ArrayList<>();
    ...
    /**
     * Accepts the constructor arguments of {@link javafx.scene.shape.MeshView#MeshView(javafx.scene.shape.Mesh) MeshView(Mesh)}
     ...
     * @return builder instance
     */
    public  MeshViewBuilder onMouseDragDone(javafx.event.EventHandler<? super javafx.scene.input.MouseDragEvent> value) {
     ...
     * returned by the {@link javafx.scene.Node#getStyleClass() MeshView#getStyleClass()} method.
     * 
     * @return builder instance
     */
    ...
    /**
     * Calls the {@link javafx.collections.ObservableList#addAll(java.lang.Object[]) addAll} method on the ObservableList
     * returned by the {@link javafx.scene.Node#getTransforms() MeshView#getTransforms()} method.
     * 
     * @return builder instance
     */
     ...
     * @return builder instance
     */
    public MeshViewBuilder onMouseDragDonePropertyApply(java.util.function.Consumer<javafx.beans.property.ObjectProperty<javafx.event.EventHandler<? super javafx.scene.input.MouseDragEvent>>> op) {
