...
public class SubSceneBuilder {
    private final java.util.List<java.util.function.Consumer<javafx.scene.SubScene>> operations = new java.util.ArrayList<>();
    private SubSceneBuilder() {}
    
    /**
     * Accepts the constructor arguments of {@link javafx.scene.SubScene#SubScene(javafx.scene.Parent, double, double) SubScene(Parent, double, double)}
    ...
    /**
     * Accepts the constructor arguments of {@link javafx.scene.SubScene#SubScene(javafx.scene.Parent, double, double, boolean, javafx.scene.SceneAntialiasing) SubScene(Parent, double, double, boolean, SceneAntialiasing)}
     * and returns an instance of {@code SubSceneBuilder}.
     *
     * @return an instance of the {@code SubSceneBuilder}.
     */
     ...
     * @return builder instance
     */
    public  SubSceneBuilder onMouseDragDone(javafx.event.EventHandler<? super javafx.scene.input.MouseDragEvent> value) {
     ...
     * returned by the {@link javafx.scene.Node#getStyleClass() SubScene#getStyleClass()} method.
     * 
     * @return builder instance
     */
    ...
    /**
     * Calls the {@link javafx.collections.ObservableList#addAll(java.lang.Object[]) addAll} method on the ObservableList
     * returned by the {@link javafx.scene.Node#getTransforms() SubScene#getTransforms()} method.
     * 
     * @return builder instance
     */
     ...
     * This serves as a shorthand form of the {@link SubSceneBuilder#apply(java.util.function.Consumer) apply} method.
     * <p>
     * Example: 
     * </p>
     * {@snippet :
     ...
     * @return builder instance
     */
    public SubSceneBuilder onMouseDragDonePropertyApply(java.util.function.Consumer<javafx.beans.property.ObjectProperty<javafx.event.EventHandler<? super javafx.scene.input.MouseDragEvent>>> op) {
