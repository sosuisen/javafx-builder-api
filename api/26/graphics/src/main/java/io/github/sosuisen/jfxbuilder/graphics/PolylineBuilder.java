...
public class PolylineBuilder {
    private final java.util.List<java.util.function.Consumer<javafx.scene.shape.Polyline>> operations = new java.util.ArrayList<>();
    ...
    /**
     * Builds and returns an instance of the {@link javafx.scene.shape.Polyline Polyline} class.
     * 
     * <p>
     ...
     * @return builder instance
     */
    public  PolylineBuilder onMouseDragDone(javafx.event.EventHandler<? super javafx.scene.input.MouseDragEvent> value) {
     ...
     * @return builder instance
     */
    public PolylineBuilder onMouseDragDonePropertyApply(java.util.function.Consumer<javafx.beans.property.ObjectProperty<javafx.event.EventHandler<? super javafx.scene.input.MouseDragEvent>>> op) {
