...
public class CanvasBuilder {
    private final java.util.List<java.util.function.Consumer<javafx.scene.canvas.Canvas>> operations = new java.util.ArrayList<>();
     ...
     * @return builder instance
     */
    public  CanvasBuilder onMouseDragDone(javafx.event.EventHandler<? super javafx.scene.input.MouseDragEvent> value) {
     ...
     * @return builder instance
     */
    public CanvasBuilder onMouseDragDonePropertyApply(java.util.function.Consumer<javafx.beans.property.ObjectProperty<javafx.event.EventHandler<? super javafx.scene.input.MouseDragEvent>>> op) {
