...
public class SceneBuilder {
    ...
    /**
     * A builder method that invokes the {@link javafx.scene.Scene#setOnMouseDragDone(javafx.event.EventHandler) setOnMouseDragDone} method on the instance being constructed.
     *
     * @return builder instance
     */
    public  SceneBuilder onMouseDragDone(javafx.event.EventHandler<? super javafx.scene.input.MouseDragEvent> value) {
    ...
    /**
     * Applies a function to the {@link javafx.scene.Scene#onMouseDragDoneProperty() onMouseDragDoneProperty} 
     * of the instance being constructed. 
     * This serves as a shorthand form of the {@link SceneBuilder#apply(java.util.function.Consumer) apply} method.
     * <p>
     * Example: 
     ...
     * @return builder instance
     */
    public SceneBuilder onMouseDragDonePropertyApply(java.util.function.Consumer<javafx.beans.property.ObjectProperty<javafx.event.EventHandler<? super javafx.scene.input.MouseDragEvent>>> op) {
