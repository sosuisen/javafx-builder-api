...
public class RobotBuilder {
    private final java.util.List<java.util.function.Consumer<javafx.scene.robot.Robot>> operations = new java.util.ArrayList<>();
    ...
    /**
     * Builds and returns an instance of the {@link javafx.scene.robot.Robot Robot} class.
     * 
     * <p>
