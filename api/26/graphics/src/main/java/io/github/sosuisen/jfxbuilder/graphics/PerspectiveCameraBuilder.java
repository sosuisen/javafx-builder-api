...
/**
 * The {@code PerspectiveCameraBuilder} class constructs instances of the {@link javafx.scene.PerspectiveCamera PerspectiveCamera} class 
 * and offers a fluent interface for creating and configuring it. 
 *
 * <p>
 * This class includes a static {@code create} method that accepts the same arguments as the original {@link javafx.scene.PerspectiveCamera PerspectiveCamera} constructor
 * and returns an instance of the {@code PerspectiveCameraBuilder}.
 * </p>
 *
 * <p>
 * You can use method chaining to call the builder methods for configuring the {@link javafx.scene.PerspectiveCamera PerspectiveCamera}.
 * Finally, invoke the {@code build} method to generate an instance of the {@link javafx.scene.PerspectiveCamera PerspectiveCamera} class.
 * </p>
 *
 * <p>
...
public class PerspectiveCameraBuilder {
    private final java.util.List<java.util.function.Consumer<javafx.scene.PerspectiveCamera>> operations = new java.util.ArrayList<>();
    ...
    /**
     * Builds and returns an instance of the {@link javafx.scene.PerspectiveCamera PerspectiveCamera} class.
     * 
     * <p>
     ...
     * </p>
     *
     * @return new instance of the {@link javafx.scene.PerspectiveCamera PerspectiveCamera} class
     */
     ...
     * @return builder instance
     */
    public  PerspectiveCameraBuilder onMouseDragDone(javafx.event.EventHandler<? super javafx.scene.input.MouseDragEvent> value) {
     ...
     * This serves as a shorthand form of the {@link PerspectiveCameraBuilder#apply(java.util.function.Consumer) apply} method.
     * <p>
     * Example: 
     * </p>
     * {@snippet :
     ...
     * @return builder instance
     */
    public PerspectiveCameraBuilder onMouseDragDonePropertyApply(java.util.function.Consumer<javafx.beans.property.ObjectProperty<javafx.event.EventHandler<? super javafx.scene.input.MouseDragEvent>>> op) {
