...
public class MediaViewBuilder {
    private final java.util.List<java.util.function.Consumer<javafx.scene.media.MediaView>> operations = new java.util.ArrayList<>();
    ...
    /**
     * Accepts the constructor arguments of {@link javafx.scene.media.MediaView#MediaView(javafx.scene.media.MediaPlayer) MediaView(MediaPlayer)}
    ...
    /**
     * Builds and returns an instance of the {@link javafx.scene.media.MediaView MediaView} class.
     * 
     * <p>
     ...
     * @return builder instance
     */
    public  MediaViewBuilder onMouseDragDone(javafx.event.EventHandler<? super javafx.scene.input.MouseDragEvent> value) {
     ...
     * returned by the {@link javafx.scene.Node#getStyleClass() MediaView#getStyleClass()} method.
     * 
     * @return builder instance
     */
    ...
    /**
     * Calls the {@link javafx.collections.ObservableList#addAll(java.lang.Object[]) addAll} method on the ObservableList
     * returned by the {@link javafx.scene.Node#getTransforms() MediaView#getTransforms()} method.
     * 
     * @return builder instance
     */
     ...
     * This serves as a shorthand form of the {@link MediaViewBuilder#apply(java.util.function.Consumer) apply} method.
     * <p>
     * Example: 
     * </p>
     * {@snippet :
     ...
     * @return builder instance
     */
    public MediaViewBuilder onMouseDragDonePropertyApply(java.util.function.Consumer<javafx.beans.property.ObjectProperty<javafx.event.EventHandler<? super javafx.scene.input.MouseDragEvent>>> op) {
