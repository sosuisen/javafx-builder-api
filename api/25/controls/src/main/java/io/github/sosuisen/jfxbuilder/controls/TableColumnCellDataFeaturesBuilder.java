...
public class TableColumnCellDataFeaturesBuilder<S, T> {
    ...
    /**
     * Accepts the constructor arguments of {@link javafx.scene.control.TableColumn.CellDataFeatures#CellDataFeatures(javafx.scene.control.TableView, javafx.scene.control.TableColumn, java.lang.Object) CellDataFeatures(TableView, TableColumn, S)}
