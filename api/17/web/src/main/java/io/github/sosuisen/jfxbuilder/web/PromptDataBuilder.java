...
/**
 * The {@code PromptDataBuilder} class constructs instances of the {@link javafx.scene.web.PromptData PromptData} class 
 * and offers a fluent interface for creating and configuring it. 
 *
 * <p>
 * This class includes a static {@code create} method that accepts the same arguments as the original {@link javafx.scene.web.PromptData PromptData} constructor
 * and returns an instance of the {@code PromptDataBuilder}.
 * </p>
 *
 * <p>
 * You can use method chaining to call the builder methods for configuring the {@link javafx.scene.web.PromptData PromptData}.
 * Finally, invoke the {@code build} method to generate an instance of the {@link javafx.scene.web.PromptData PromptData} class.
 * </p>
 *
 * <p>
...
public class PromptDataBuilder {
    ...
    /**
     * Builds and returns an instance of the {@link javafx.scene.web.PromptData PromptData} class.
     * 
     * <p>
    ...
    public javafx.scene.web.PromptData build() {
        ...
        for (java.util.function.Consumer<javafx.scene.web.PromptData> op : operations) {
    ...
    private javafx.scene.web.PromptData callParameterizedConstructor() {
        javafx.scene.web.PromptData newInstance;        
        try {
            java.lang.reflect.Constructor<?>[] constructors = javafx.scene.web.PromptData.class.getConstructors();
            newInstance = null;
            for (java.lang.reflect.Constructor<?> constructor : constructors) {
                if (constructor.getParameterCount() == constructorArgs.length && isConstructorCompatible(constructor, constructorArgs)) {
                    newInstance = (javafx.scene.web.PromptData) constructor.newInstance(constructorArgs);
                    break;
                }
            }
            if (newInstance == null) {
