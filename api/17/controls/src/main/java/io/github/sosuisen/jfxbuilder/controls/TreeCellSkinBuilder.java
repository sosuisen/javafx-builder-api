...
public class TreeCellSkinBuilder<T> {
    private final java.util.List<java.util.function.Consumer<javafx.scene.control.skin.TreeCellSkin<T>>> operations = new java.util.ArrayList<>();
    private TreeCellSkinBuilder() {}
    
    /**
     * Accepts the constructor arguments of {@link javafx.scene.control.skin.TreeCellSkin#TreeCellSkin(javafx.scene.control.TreeCell) TreeCellSkin(TreeCell)}
    ...
    /**
     * Builds and returns an instance of the {@link javafx.scene.control.skin.TreeCellSkin TreeCellSkin} class.
     * 
     * <p>
