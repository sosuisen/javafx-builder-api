...
public class ClosePathBuilder {
    private final java.util.List<java.util.function.Consumer<javafx.scene.shape.ClosePath>> operations = new java.util.ArrayList<>();
    ...
    /**
     * Builds and returns an instance of the {@link javafx.scene.shape.ClosePath ClosePath} class.
     * 
     * <p>
