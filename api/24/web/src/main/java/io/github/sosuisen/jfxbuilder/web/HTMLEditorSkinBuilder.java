...
public class HTMLEditorSkinBuilder {
    private final java.util.List<java.util.function.Consumer<javafx.scene.web.HTMLEditorSkin>> operations = new java.util.ArrayList<>();
    private HTMLEditorSkinBuilder() {}
    
    /**
     * Accepts the constructor arguments of {@link javafx.scene.web.HTMLEditorSkin#HTMLEditorSkin(javafx.scene.web.HTMLEditor) HTMLEditorSkin(HTMLEditor)}
    ...
    /**
     * Calls the {@link javafx.collections.ObservableList#addAll(java.lang.Object[]) addAll} method on the ObservableList returned by the {@link javafx.scene.web.HTMLEditorSkin#getChildren()} method.
     * 
     * @return builder instance
     */
    ...
    /**
     * Calls the {@link java.util.List#addAll(java.util.Collection) addAll} method on the ObservableList returned by the {@link javafx.scene.web.HTMLEditorSkin#getChildren()} method.
     * 
     * @return builder instance
     */
