...
class AreaChartBuilderTest {
  ...
  void testWithDataCollection() {
    ...
    ObservableList<XYChart.Series<String, Number>> seriesList = FXCollections.observableArrayList(series1, series2);
  ...
  @Test
  @DisplayName("Test inferred xAxis and yAxis types with Collection - Number and String")
  void testInferredAxesTypesWithCollectionNumberAndString() {
    ...
    @SuppressWarnings("unchecked")
    ObservableList<XYChart.Series<Number, String>> seriesList = FXCollections.observableArrayList(series1, series2);
