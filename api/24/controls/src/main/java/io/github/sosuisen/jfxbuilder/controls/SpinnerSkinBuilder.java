...
public class SpinnerSkinBuilder<T> {
    private final java.util.List<java.util.function.Consumer<javafx.scene.control.skin.SpinnerSkin<T>>> operations = new java.util.ArrayList<>();
    private SpinnerSkinBuilder() {}
    
    /**
     * Accepts the constructor arguments of {@link javafx.scene.control.skin.SpinnerSkin#SpinnerSkin(javafx.scene.control.Spinner) SpinnerSkin(Spinner)}
    ...
    /**
     * Builds and returns an instance of the {@link javafx.scene.control.skin.SpinnerSkin} class.
     * 
     * <p>
    ...
    /**
     * Calls the {@link javafx.collections.ObservableList#addAll(java.lang.Object[]) addAll} method on the ObservableList returned by the {@link javafx.scene.control.skin.SpinnerSkin#getChildren()} method.
     * 
     * @return builder instance
     */
    ...
    /**
     * Calls the {@link java.util.List#addAll(java.util.Collection) addAll} method on the ObservableList returned by the {@link javafx.scene.control.skin.SpinnerSkin#getChildren()} method.
     * 
     * @return builder instance
     */
