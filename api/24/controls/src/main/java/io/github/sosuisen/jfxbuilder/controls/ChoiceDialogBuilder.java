...
public class ChoiceDialogBuilder<T> {
    ...
    /**
     * Builds and returns an instance of the {@link javafx.scene.control.ChoiceDialog ChoiceDialog} class.
     * 
     * <p>
     ...
     * returned by the {@link javafx.scene.control.ChoiceDialog#getItems() ChoiceDialog#getItems()} method.
     * 
     * @return builder instance
     */
    @SafeVarargs
