...
public class LineChartBuilder<X, Y> {
     ...
     *
     * <p>
     * After calling this method, you may need to invoke the {@link LineChartBuilder<X, Y>#xAxis(javafx.scene.chart.Axis) xAxis(Axis)} and {@link LineChartBuilder<X, Y>#yAxis(javafx.scene.chart.Axis) yAxis(Axis)} methods. 
     ...
     *
     * This method is used together with the {@link LineChartBuilder<X, Y>#withData(Series...)} or the {@link LineChartBuilder<X, Y>#withData(java.util.Collection col)}.
     *
     * @return builder instance
     */
