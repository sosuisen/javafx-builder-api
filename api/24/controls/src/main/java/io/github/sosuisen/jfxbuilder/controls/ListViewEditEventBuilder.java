...
public class ListViewEditEventBuilder<T> {
    ...
    /**
     * Accepts the constructor arguments of {@link javafx.scene.control.ListView.EditEvent#EditEvent(javafx.scene.control.ListView, javafx.event.EventType, java.lang.Object, int) EditEvent(ListView, EventType, T, int)}
    ...
    /**
     * Builds and returns an instance of the {@link javafx.scene.control.ListView.EditEvent EditEvent} class.
     * 
     * <p>
