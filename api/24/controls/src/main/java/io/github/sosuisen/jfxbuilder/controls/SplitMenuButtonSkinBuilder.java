...
public class SplitMenuButtonSkinBuilder {
    private final java.util.List<java.util.function.Consumer<javafx.scene.control.skin.SplitMenuButtonSkin>> operations = new java.util.ArrayList<>();
    private SplitMenuButtonSkinBuilder() {}
    
    /**
     * Accepts the constructor arguments of {@link javafx.scene.control.skin.SplitMenuButtonSkin#SplitMenuButtonSkin(javafx.scene.control.SplitMenuButton) SplitMenuButtonSkin(SplitMenuButton)}
    ...
    /**
     * Calls the {@link javafx.collections.ObservableList#addAll(java.lang.Object[]) addAll} method on the ObservableList returned by the {@link javafx.scene.control.skin.SplitMenuButtonSkin#getChildren()} method.
     * 
     * @return builder instance
     */
    ...
    /**
     * Calls the {@link java.util.List#addAll(java.util.Collection) addAll} method on the ObservableList returned by the {@link javafx.scene.control.skin.SplitMenuButtonSkin#getChildren()} method.
     * 
     * @return builder instance
     */
