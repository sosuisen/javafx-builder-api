...
public class BubbleChartBuilder<X, Y> {
    private final java.util.List<java.util.function.Consumer<javafx.scene.chart.BubbleChart<X, Y>>> operations = new java.util.ArrayList<>();
    private BubbleChartBuilder() {}
    
    /**
     * Accepts the constructor arguments of {@link javafx.scene.chart.BubbleChart#BubbleChart(javafx.scene.chart.Axis, javafx.scene.chart.Axis) BubbleChart(Axis, Axis)}
    ...
    /**
     * Accepts the constructor arguments of {@link javafx.scene.chart.BubbleChart#BubbleChart(javafx.scene.chart.Axis, javafx.scene.chart.Axis, javafx.collections.ObservableList) BubbleChart(Axis, Axis, ObservableList)}
     * and returns an instance of {@code BubbleChartBuilder<X, Y>}.
     *
     * @return an instance of the {@code BubbleChartBuilder<X, Y>}.
     */
    ...
    /**
     * Builds and returns an instance of the {@link javafx.scene.chart.BubbleChart} class.
     * 
     * <p>
     ...
     *
     * <p>
     * After calling this method, you may need to invoke the {@link io.github.sosuisen.jfxbuilder.controls.BubbleChartBuilder#xAxis(javafx.scene.chart.Axis) xAxis(Axis)} and {@link io.github.sosuisen.jfxbuilder.controls.BubbleChartBuilder#yAxis(javafx.scene.chart.Axis) yAxis(Axis)} methods. 
     ...
     * This method is used together with the {@link io.github.sosuisen.jfxbuilder.controls.BubbleChartBuilder#withData(javafx.scene.chart.XYChart.Series...) withData(Series...)} or the {@link io.github.sosuisen.jfxbuilder.controls.BubbleChartBuilder#withData(java.util.Collection col) withData(Collection)}.
     *
     * @return builder instance
     */
