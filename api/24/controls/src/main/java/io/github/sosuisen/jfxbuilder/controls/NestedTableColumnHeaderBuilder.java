...
/**
 * The {@code NestedTableColumnHeaderBuilder} class constructs instances of the {@link javafx.scene.control.skin.NestedTableColumnHeader NestedTableColumnHeader} class 
 * and offers a fluent interface for creating and configuring it. 
 *
 * <p>
 * This class includes a static {@code create} method that accepts the same arguments as the original {@link javafx.scene.control.skin.NestedTableColumnHeader NestedTableColumnHeader} constructor
 * and returns an instance of the {@code NestedTableColumnHeaderBuilder}.
 * </p>
 *
 * <p>
 * You can use method chaining to call the builder methods for configuring the {@link javafx.scene.control.skin.NestedTableColumnHeader NestedTableColumnHeader}.
 * Finally, invoke the {@code build} method to generate an instance of the {@link javafx.scene.control.skin.NestedTableColumnHeader NestedTableColumnHeader} class.
 * </p>
 *
 * <p>
...
public class NestedTableColumnHeaderBuilder {
    private final java.util.List<java.util.function.Consumer<javafx.scene.control.skin.NestedTableColumnHeader>> operations = new java.util.ArrayList<>();
    private NestedTableColumnHeaderBuilder() {}
    
    /**
     * Accepts the constructor arguments of {@link javafx.scene.control.skin.NestedTableColumnHeader#NestedTableColumnHeader(javafx.scene.control.TableColumnBase) NestedTableColumnHeader(TableColumnBase)}
     ...
     * </p>
     *
     * @return new instance of the {@link javafx.scene.control.skin.NestedTableColumnHeader NestedTableColumnHeader} class
     */
    ...
    /**
     * Calls the {@link javafx.collections.ObservableList#addAll(java.lang.Object[]) addAll} method on the ObservableList returned by the {@link javafx.scene.control.skin.NestedTableColumnHeader#getColumnHeaders()} method.
     * 
     * @return builder instance
     */
    public final NestedTableColumnHeaderBuilder addColumnHeaders(javafx.scene.control.skin.TableColumnHeader... elements) {
        operations.add(obj -> obj.getColumnHeaders().addAll(elements));
        return this;
    }

    /**
     * Calls the {@link java.util.List#addAll(java.util.Collection) addAll} method on the ObservableList returned by the {@link javafx.scene.control.skin.NestedTableColumnHeader#getColumnHeaders()} method.
     * 
     * @return builder instance
     */
    public final NestedTableColumnHeaderBuilder addColumnHeaders(java.util.Collection<? extends javafx.scene.control.skin.TableColumnHeader> col) {
        operations.add(obj -> obj.getColumnHeaders().addAll(col));
        return this;
    }

    /**
     * Calls the {@link javafx.collections.ObservableList#addAll(java.lang.Object[]) addAll} method on the ObservableList returned by the {@link javafx.scene.control.skin.NestedTableColumnHeader#getStyleClass()} method.
     * 
     * @return builder instance
     */
    ...
    /**
     * Calls the {@link java.util.List#addAll(java.util.Collection) addAll} method on the ObservableList returned by the {@link javafx.scene.control.skin.NestedTableColumnHeader#getStyleClass()} method.
     * 
     * @return builder instance
     */
    ...
    /**
     * Calls the {@link javafx.collections.ObservableList#addAll(java.lang.Object[]) addAll} method on the ObservableList returned by the {@link javafx.scene.control.skin.NestedTableColumnHeader#getStylesheets()} method.
     * 
     * @return builder instance
     */
    ...
    /**
     * Calls the {@link java.util.List#addAll(java.util.Collection) addAll} method on the ObservableList returned by the {@link javafx.scene.control.skin.NestedTableColumnHeader#getStylesheets()} method.
     * 
     * @return builder instance
     */
    ...
    /**
     * Calls the {@link javafx.collections.ObservableList#addAll(java.lang.Object[]) addAll} method on the ObservableList returned by the {@link javafx.scene.control.skin.NestedTableColumnHeader#getTransforms()} method.
     * 
     * @return builder instance
     */
    ...
    /**
     * Calls the {@link java.util.List#addAll(java.util.Collection) addAll} method on the ObservableList returned by the {@link javafx.scene.control.skin.NestedTableColumnHeader#getTransforms()} method.
     * 
     * @return builder instance
     */
