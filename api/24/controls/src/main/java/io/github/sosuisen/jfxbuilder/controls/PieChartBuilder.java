...
public class PieChartBuilder {
    ...
    /**
     * Creates an instance of the builder, then calls the {@link javafx.collections.ObservableList#addAll(E... elements) addAll} method on the ObservableList returned by the {@link javafx.scene.chart.PieChart#getData()} method.
     * 
     * @return builder instance
     */
    @SafeVarargs
    ...
    /**
     * Creates an instance of the builder, then calls the {@link java.util.List#addAll(Collection<? extends E> c) addAll} method on the ObservableList returned by the {@link javafx.scene.chart.PieChart#getData()} method.
     * 
     * @return builder instance
     */
