...
public class ChoiceBoxSkinBuilder<T> {
    ...
    /**
     * Builds and returns an instance of the {@link javafx.scene.control.skin.ChoiceBoxSkin} class.
     * 
     * <p>
    ...
    /**
     * Calls the {@link javafx.collections.ObservableList#addAll(java.lang.Object[]) addAll} method on the ObservableList returned by the {@link javafx.scene.control.skin.ChoiceBoxSkin#getChildren()} method.
     * 
     * @return builder instance
     */
    ...
    /**
     * Calls the {@link java.util.List#addAll(java.util.Collection) addAll} method on the ObservableList returned by the {@link javafx.scene.control.skin.ChoiceBoxSkin#getChildren()} method.
     * 
     * @return builder instance
     */
