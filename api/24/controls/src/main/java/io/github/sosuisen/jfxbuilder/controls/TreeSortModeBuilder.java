...
public class TreeSortModeBuilder {
    private final java.util.List<java.util.function.Consumer<javafx.scene.control.TreeSortMode>> operations = new java.util.ArrayList<>();
    private TreeSortModeBuilder() {}
    
    private Object[] constructorArgs;

    /**
     * Builds and returns an instance of the {@link javafx.scene.control.TreeSortMode TreeSortMode} class.
     * 
     * <p>
     ...
     * </p>
     *
     * @return new instance of the {@link javafx.scene.control.TreeSortMode TreeSortMode} class
     */
    public javafx.scene.control.TreeSortMode build() {
        javafx.scene.control.TreeSortMode newInstance;

        newInstance = callParameterizedConstructor();


        for (java.util.function.Consumer<javafx.scene.control.TreeSortMode> op : operations) {
    ...
    private javafx.scene.control.TreeSortMode callParameterizedConstructor() {
        javafx.scene.control.TreeSortMode newInstance;        
        try {
            java.lang.reflect.Constructor<?>[] constructors = javafx.scene.control.TreeSortMode.class.getConstructors();
            newInstance = null;
            for (java.lang.reflect.Constructor<?> constructor : constructors) {
                if (constructor.getParameterCount() == constructorArgs.length && isConstructorCompatible(constructor, constructorArgs)) {
                    newInstance = (javafx.scene.control.TreeSortMode) constructor.newInstance(constructorArgs);
                    break;
                }
            }
            if (newInstance == null) {
