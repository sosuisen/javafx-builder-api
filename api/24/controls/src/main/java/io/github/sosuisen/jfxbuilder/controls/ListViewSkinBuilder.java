...
public class ListViewSkinBuilder<T> {
    private final java.util.List<java.util.function.Consumer<javafx.scene.control.skin.ListViewSkin<T>>> operations = new java.util.ArrayList<>();
    private ListViewSkinBuilder() {}
    
    /**
     * Accepts the constructor arguments of {@link javafx.scene.control.skin.ListViewSkin#ListViewSkin(javafx.scene.control.ListView) ListViewSkin(ListView)}
     * and returns an instance of {@code ListViewSkinBuilder<T>}.
     *
    ...
    /**
     * Builds and returns an instance of the {@link javafx.scene.control.skin.ListViewSkin} class.
     * 
     * <p>
    ...
    /**
     * Calls the {@link javafx.collections.ObservableList#addAll(java.lang.Object[]) addAll} method on the ObservableList returned by the {@link javafx.scene.control.skin.ListViewSkin#getChildren()} method.
     * 
     * @return builder instance
     */
    ...
    /**
     * Calls the {@link java.util.List#addAll(java.util.Collection) addAll} method on the ObservableList returned by the {@link javafx.scene.control.skin.ListViewSkin#getChildren()} method.
     * 
     * @return builder instance
     */
