...
public class ButtonBarSkinBuilder {
    private final java.util.List<java.util.function.Consumer<javafx.scene.control.skin.ButtonBarSkin>> operations = new java.util.ArrayList<>();
    private ButtonBarSkinBuilder() {}
    
    /**
     * Accepts the constructor arguments of {@link javafx.scene.control.skin.ButtonBarSkin#ButtonBarSkin(javafx.scene.control.ButtonBar) ButtonBarSkin(ButtonBar)}
    ...
    /**
     * Calls the {@link javafx.collections.ObservableList#addAll(java.lang.Object[]) addAll} method on the ObservableList returned by the {@link javafx.scene.control.skin.ButtonBarSkin#getChildren()} method.
     * 
     * @return builder instance
     */
    ...
    /**
     * Calls the {@link java.util.List#addAll(java.util.Collection) addAll} method on the ObservableList returned by the {@link javafx.scene.control.skin.ButtonBarSkin#getChildren()} method.
     * 
     * @return builder instance
     */
