...
public class TableColumnBuilder<S, T> {
     ...
     * returned by the {@link javafx.scene.control.TableColumn#getColumns() TableColumn#getColumns()} method.
     * 
     * @return builder instance
     */
    @SafeVarargs
    ...
    /**
     * Calls the {@link javafx.collections.ObservableList#addAll(java.lang.Object[]) addAll} method on the ObservableList
     * returned by the {@link javafx.scene.control.TableColumnBase#getStyleClass() TableColumn#getStyleClass()} method.
     * 
     * @return builder instance
     */
