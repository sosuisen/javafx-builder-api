...
public class StackedAreaChartBuilder<X, Y> {
     ...
     *
     * <p>
     * After calling this method, you may need to invoke the {@link StackedAreaChartBuilder<X, Y>#xAxis(javafx.scene.chart.Axis) xAxis(Axis)} and {@link StackedAreaChartBuilder<X, Y>#yAxis(javafx.scene.chart.Axis) yAxis(Axis)} methods. 
     ...
     *
     * This method is used together with the {@link StackedAreaChartBuilder<X, Y>#withData(Series...)} or the {@link StackedAreaChartBuilder<X, Y>#withData(java.util.Collection col)}.
     *
     * @return builder instance
     */
