...
public class AreaChartBuilder<X, Y> {
    ...
    /**
     * Builds and returns an instance of the {@link javafx.scene.chart.AreaChart<X, Y>} class.
     * 
     * <p>
     ...
     *
     * <p>
     * After calling this method, you may need to invoke the {@link AreaChartBuilder<X, Y>#xAxis(javafx.scene.chart.Axis) xAxis(Axis)} and {@link AreaChartBuilder<X, Y>#yAxis(javafx.scene.chart.Axis) yAxis(Axis)} methods. 
     ...
     *
     * This method is used together with the {@link AreaChartBuilder<X, Y>#withData(Series...)} or the {@link AreaChartBuilder<X, Y>#withData(java.util.Collection col)}.
     *
     * @return builder instance
     */
