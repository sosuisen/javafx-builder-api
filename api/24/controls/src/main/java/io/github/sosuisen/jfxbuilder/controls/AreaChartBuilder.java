...
public class AreaChartBuilder<X, Y> {
    private final java.util.List<java.util.function.Consumer<javafx.scene.chart.AreaChart<X, Y>>> operations = new java.util.ArrayList<>();
    private AreaChartBuilder() {}
    
    /**
     * Accepts the constructor arguments of {@link javafx.scene.chart.AreaChart#AreaChart(javafx.scene.chart.Axis, javafx.scene.chart.Axis) AreaChart(Axis, Axis)}
    ...
    /**
     * Accepts the constructor arguments of {@link javafx.scene.chart.AreaChart#AreaChart(javafx.scene.chart.Axis, javafx.scene.chart.Axis, javafx.collections.ObservableList) AreaChart(Axis, Axis, ObservableList)}
     * and returns an instance of {@code AreaChartBuilder<X, Y>}.
     *
     * @return an instance of the {@code AreaChartBuilder<X, Y>}.
     */
    ...
    /**
     * Builds and returns an instance of the {@link javafx.scene.chart.AreaChart} class.
     * 
     * <p>
    ...
    /**
     * A builder method that invokes the {@link javafx.scene.chart.AreaChart#setCreateSymbols(boolean) setCreateSymbols} method on the instance being constructed.
     *
     * @return builder instance
     */
    ...
    /**
     * Calls the {@link javafx.collections.ObservableList#addAll(java.lang.Object[]) addAll} method on the ObservableList returned by the {@link javafx.scene.chart.AreaChart#getData()} method.
     * 
     * @return builder instance
     */
    @SafeVarargs
    ...
    /**
     * Calls the {@link java.util.List#addAll(java.util.Collection) addAll} method on the ObservableList returned by the {@link javafx.scene.chart.AreaChart#getData()} method.
     * 
     * @return builder instance
     */
    ...
    /**
     * Calls the {@link javafx.collections.ObservableList#addAll(java.lang.Object[]) addAll} method on the ObservableList returned by the {@link javafx.scene.chart.AreaChart#getStyleClass()} method.
     * 
     * @return builder instance
     */
    ...
    /**
     * Calls the {@link java.util.List#addAll(java.util.Collection) addAll} method on the ObservableList returned by the {@link javafx.scene.chart.AreaChart#getStyleClass()} method.
     * 
     * @return builder instance
     */
    ...
    /**
     * Calls the {@link javafx.collections.ObservableList#addAll(java.lang.Object[]) addAll} method on the ObservableList returned by the {@link javafx.scene.chart.AreaChart#getStylesheets()} method.
     * 
     * @return builder instance
     */
    ...
    /**
     * Calls the {@link java.util.List#addAll(java.util.Collection) addAll} method on the ObservableList returned by the {@link javafx.scene.chart.AreaChart#getStylesheets()} method.
     * 
     * @return builder instance
     */
    ...
    /**
     * Calls the {@link javafx.collections.ObservableList#addAll(java.lang.Object[]) addAll} method on the ObservableList returned by the {@link javafx.scene.chart.AreaChart#getTransforms()} method.
     * 
     * @return builder instance
     */
    ...
    /**
     * Calls the {@link java.util.List#addAll(java.util.Collection) addAll} method on the ObservableList returned by the {@link javafx.scene.chart.AreaChart#getTransforms()} method.
     * 
     * @return builder instance
     */
     ...
     * on the ObservableList returned by the {@link javafx.scene.chart.AreaChart#getData() AreaChart#getData()} method.
     *
     * <p>
     * After calling this method, you may need to invoke the {@link io.github.sosuisen.jfxbuilder.controls.AreaChartBuilder#xAxis(javafx.scene.chart.Axis) xAxis(Axis)} and {@link io.github.sosuisen.jfxbuilder.controls.AreaChartBuilder#yAxis(javafx.scene.chart.Axis) yAxis(Axis)} methods. 
     ...
     */
    @SafeVarargs
    public static <X, Y> AreaChartBuilder<X, Y> withData(javafx.scene.chart.XYChart.Series<X, Y>... elements) {
        AreaChartBuilder<X, Y> builder = new AreaChartBuilder<X, Y>();
     ...
     * @return builder instance
     */
    public static <X, Y> AreaChartBuilder<X, Y> withData(java.util.Collection<? extends javafx.scene.chart.XYChart.Series<X, Y>> col) {
        AreaChartBuilder<X, Y> builder = new AreaChartBuilder<X, Y>();
        builder.constructorArgs = new Object[]{new javafx.scene.chart.CategoryAxis(), new javafx.scene.chart.NumberAxis()};
    ...
    private static <X, Y> void setDefaultConstructorArgs(AreaChartBuilder<X, Y> builder,
     ...
     * This method is used together with the {@link io.github.sosuisen.jfxbuilder.controls.AreaChartBuilder#withData(javafx.scene.chart.XYChart.Series...) withData(Series...)} or the {@link io.github.sosuisen.jfxbuilder.controls.AreaChartBuilder#withData(java.util.Collection col) withData(Collection)}.
     *
     * @return builder instance
     */
    public AreaChartBuilder<X, Y> xAxis(javafx.scene.chart.Axis<X> axis) {
     ...
     * @return builder instance
     */
    public AreaChartBuilder<X, Y> yAxis(javafx.scene.chart.Axis<Y> axis) {
