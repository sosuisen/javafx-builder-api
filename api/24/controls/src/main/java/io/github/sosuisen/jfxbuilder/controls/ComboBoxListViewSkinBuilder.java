...
public class ComboBoxListViewSkinBuilder<T> {
     ...
     * returned by the {@link javafx.scene.control.SkinBase#getChildren() ComboBoxListViewSkin#getChildren()} method.
     * 
     * @return builder instance
     */
     ...
     * This serves as a shorthand form of the {@link ComboBoxListViewSkinBuilder#apply(java.util.function.Consumer) apply} method.
     * <p>
     * Example: 
     * </p>
     * <pre>{@code
