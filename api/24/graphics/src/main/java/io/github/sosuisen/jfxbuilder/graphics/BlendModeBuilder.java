...
public class BlendModeBuilder {
    private final java.util.List<java.util.function.Consumer<javafx.scene.effect.BlendMode>> operations = new java.util.ArrayList<>();
    private BlendModeBuilder() {}
    
    private Object[] constructorArgs;

    /**
     * Builds and returns an instance of the {@link javafx.scene.effect.BlendMode BlendMode} class.
     * 
     * <p>
