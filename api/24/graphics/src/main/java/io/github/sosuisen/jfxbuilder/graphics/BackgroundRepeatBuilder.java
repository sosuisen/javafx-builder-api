...
public class BackgroundRepeatBuilder {
    private final java.util.List<java.util.function.Consumer<javafx.scene.layout.BackgroundRepeat>> operations = new java.util.ArrayList<>();
    private BackgroundRepeatBuilder() {}
    
    private Object[] constructorArgs;

    /**
     * Builds and returns an instance of the {@link javafx.scene.layout.BackgroundRepeat BackgroundRepeat} class.
     * 
     * <p>
