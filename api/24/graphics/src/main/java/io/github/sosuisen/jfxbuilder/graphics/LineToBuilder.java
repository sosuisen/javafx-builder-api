...
public class LineToBuilder {
    private final java.util.List<java.util.function.Consumer<javafx.scene.shape.LineTo>> operations = new java.util.ArrayList<>();
    ...
    /**
     * Builds and returns an instance of the {@link javafx.scene.shape.LineTo LineTo} class.
     * 
     * <p>
     ...
     * This serves as a shorthand form of the {@link LineToBuilder#apply(java.util.function.Consumer) apply} method.
     * <p>
     * Example: 
     * </p>
     * <pre>{@code
