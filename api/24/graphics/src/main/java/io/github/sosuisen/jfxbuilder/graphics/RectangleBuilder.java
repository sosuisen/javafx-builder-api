...
/**
 * The {@code RectangleBuilder} class constructs instances of the {@link javafx.scene.shape.Rectangle Rectangle} class 
 * and offers a fluent interface for creating and configuring it. 
 *
 * <p>
 * This class includes a static {@code create} method that accepts the same arguments as the original {@link javafx.scene.shape.Rectangle Rectangle} constructor
 * and returns an instance of the {@code RectangleBuilder}.
 * </p>
 *
 * <p>
 * You can use method chaining to call the builder methods for configuring the {@link javafx.scene.shape.Rectangle Rectangle}.
 * Finally, invoke the {@code build} method to generate an instance of the {@link javafx.scene.shape.Rectangle Rectangle} class.
 * </p>
 *
 * <p>
...
public class RectangleBuilder {
    private final java.util.List<java.util.function.Consumer<javafx.scene.shape.Rectangle>> operations = new java.util.ArrayList<>();
    ...
    /**
     * Accepts the constructor arguments of {@link javafx.scene.shape.Rectangle#Rectangle(double, double) Rectangle(double, double)}
     * and returns an instance of {@code RectangleBuilder}.
     *
     * @return an instance of the {@code RectangleBuilder}.
     */
    ...
    /**
     * Accepts the constructor arguments of {@link javafx.scene.shape.Rectangle#Rectangle(double, double, double, double) Rectangle(double, double, double, double)}
     * and returns an instance of {@code RectangleBuilder}.
     *
     * @return an instance of the {@code RectangleBuilder}.
     */
    ...
    /**
     * Accepts the constructor arguments of {@link javafx.scene.shape.Rectangle#Rectangle(double, double, javafx.scene.paint.Paint) Rectangle(double, double, Paint)}
     * and returns an instance of {@code RectangleBuilder}.
     *
     * @return an instance of the {@code RectangleBuilder}.
     */
    ...
    /**
     * Builds and returns an instance of the {@link javafx.scene.shape.Rectangle} class.
     * 
     * <p>
     ...
     * </p>
     *
     * @return new instance of the {@link javafx.scene.shape.Rectangle Rectangle} class
     */
    ...
    /**
     * Calls the {@link javafx.collections.ObservableList#addAll(java.lang.Object[]) addAll} method on the ObservableList returned by the {@link javafx.scene.shape.Rectangle#getStrokeDashArray()} method.
     * 
     * @return builder instance
     */
    ...
    /**
     * Calls the {@link java.util.List#addAll(java.util.Collection) addAll} method on the ObservableList returned by the {@link javafx.scene.shape.Rectangle#getStrokeDashArray()} method.
     * 
     * @return builder instance
     */
    ...
    /**
     * Creates an instance of the builder, then calls the {@link javafx.collections.ObservableList#addAll(java.lang.Object[]) addAll} method on the ObservableList returned by the {@link javafx.scene.shape.Rectangle#getStrokeDashArray()} method.
     * 
     * @return builder instance
     */
    ...
    /**
     * Creates an instance of the builder, then calls the {@link java.util.List#addAll(java.util.Collection) addAll} method on the ObservableList returned by the {@link javafx.scene.shape.Rectangle#getStrokeDashArray()} method.
     * 
     * @return builder instance
     */
    ...
    /**
     * Calls the {@link javafx.collections.ObservableList#addAll(java.lang.Object[]) addAll} method on the ObservableList returned by the {@link javafx.scene.shape.Rectangle#getStyleClass()} method.
     * 
     * @return builder instance
     */
    ...
    /**
     * Calls the {@link java.util.List#addAll(java.util.Collection) addAll} method on the ObservableList returned by the {@link javafx.scene.shape.Rectangle#getStyleClass()} method.
     * 
     * @return builder instance
     */
    ...
    /**
     * Calls the {@link javafx.collections.ObservableList#addAll(java.lang.Object[]) addAll} method on the ObservableList returned by the {@link javafx.scene.shape.Rectangle#getTransforms()} method.
     * 
     * @return builder instance
     */
    ...
    /**
     * Calls the {@link java.util.List#addAll(java.util.Collection) addAll} method on the ObservableList returned by the {@link javafx.scene.shape.Rectangle#getTransforms()} method.
     * 
     * @return builder instance
     */
     ...
     * <pre>{@code
     * // Use apply
     * .apply(obj -> obj.arcHeightProperty().bind(anotherProperty))
     *
     * // Use shorthand form
     * .arcHeightPropertyApply(prop -> prop.bind(anotherProperty))}
     * </pre>
     *
     * @return builder instance
     */
     ...
     * <pre>{@code
     * // Use apply
     * .apply(obj -> obj.arcWidthProperty().bind(anotherProperty))
     *
     * // Use shorthand form
     * .arcWidthPropertyApply(prop -> prop.bind(anotherProperty))}
     * </pre>
     *
     * @return builder instance
     */
