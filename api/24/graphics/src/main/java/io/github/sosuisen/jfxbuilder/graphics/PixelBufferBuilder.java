...
public class PixelBufferBuilder<T extends java.nio.Buffer> {
    ...
    /**
     * Accepts the constructor arguments of {@link javafx.scene.image.PixelBuffer#PixelBuffer(int, int, java.nio.Buffer, javafx.scene.image.PixelFormat) PixelBuffer(int, int, T, PixelFormat)}
