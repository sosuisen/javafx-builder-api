...
/**
 * The {@code FontBuilder} class constructs instances of the {@link javafx.scene.text.Font Font} class 
 * and offers a fluent interface for creating and configuring it. 
 *
 * <p>
 * This class includes a static {@code create} method that accepts the same arguments as the original {@link javafx.scene.text.Font Font} constructor
 * and returns an instance of the {@code FontBuilder}.
 * </p>
 *
 * <p>
 * You can use method chaining to call the builder methods for configuring the {@link javafx.scene.text.Font Font}.
 * Finally, invoke the {@code build} method to generate an instance of the {@link javafx.scene.text.Font Font} class.
 * </p>
 *
 * <p>
...
public class FontBuilder {
    ...
    /**
     * Builds and returns an instance of the {@link javafx.scene.text.Font Font} class.
     * 
     * <p>
    ...
    public javafx.scene.text.Font build() {
        ...
        for (java.util.function.Consumer<javafx.scene.text.Font> op : operations) {
    ...
    private javafx.scene.text.Font callParameterizedConstructor() {
        javafx.scene.text.Font newInstance;        
        try {
            java.lang.reflect.Constructor<?>[] constructors = javafx.scene.text.Font.class.getConstructors();
            newInstance = null;
            for (java.lang.reflect.Constructor<?> constructor : constructors) {
                if (constructor.getParameterCount() == constructorArgs.length && isConstructorCompatible(constructor, constructorArgs)) {
                    newInstance = (javafx.scene.text.Font) constructor.newInstance(constructorArgs);
                    break;
                }
            }
            if (newInstance == null) {
