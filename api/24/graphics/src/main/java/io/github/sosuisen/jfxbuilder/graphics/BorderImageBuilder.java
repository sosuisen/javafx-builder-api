...
/**
 * The {@code BorderImageBuilder} class constructs instances of the {@link javafx.scene.layout.BorderImage BorderImage} class 
 * and offers a fluent interface for creating and configuring it. 
 *
 * <p>
 * This class includes a static {@code create} method that accepts the same arguments as the original {@link javafx.scene.layout.BorderImage BorderImage} constructor
 * and returns an instance of the {@code BorderImageBuilder}.
 * </p>
 *
 * <p>
 * You can use method chaining to call the builder methods for configuring the {@link javafx.scene.layout.BorderImage BorderImage}.
 * Finally, invoke the {@code build} method to generate an instance of the {@link javafx.scene.layout.BorderImage BorderImage} class.
 * </p>
 *
 * <p>
...
public class BorderImageBuilder {
    private final java.util.List<java.util.function.Consumer<javafx.scene.layout.BorderImage>> operations = new java.util.ArrayList<>();
    private BorderImageBuilder() {}
    
    /**
     * Accepts the constructor arguments of {@link javafx.scene.layout.BorderImage#BorderImage(javafx.scene.image.Image, javafx.scene.layout.BorderWidths, javafx.geometry.Insets, javafx.scene.layout.BorderWidths, boolean, javafx.scene.layout.BorderRepeat, javafx.scene.layout.BorderRepeat) BorderImage(Image, BorderWidths, Insets, BorderWidths, boolean, BorderRepeat, BorderRepeat)}
     ...
     * </p>
     *
     * @return new instance of the {@link javafx.scene.layout.BorderImage BorderImage} class
     */
