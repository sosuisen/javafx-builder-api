...
public class ChoiceBoxTreeCellBuilder<T> {
    ...
    /**
     * Builds and returns an instance of the {@link javafx.scene.control.cell.ChoiceBoxTreeCell<T>} class.
     * 
     * <p>
    ...
    /**
     * Creates an instance of the builder, then calls the {@link javafx.collections.ObservableList#addAll(E... elements) addAll} method on the ObservableList returned by the {@link javafx.scene.control.cell.ChoiceBoxTreeCell#getItems()} method.
     * 
     * @return builder instance
     */
    @SafeVarargs
    ...
    /**
     * Creates an instance of the builder, then calls the {@link java.util.List#addAll(Collection<? extends E> c) addAll} method on the ObservableList returned by the {@link javafx.scene.control.cell.ChoiceBoxTreeCell#getItems()} method.
     * 
     * @return builder instance
     */
