...
public class ProgressBarTableCellBuilder<S> {
    ...
    /**
     * Builds and returns an instance of the {@link javafx.scene.control.cell.ProgressBarTableCell<S>} class.
     * 
     * <p>
    ...
    /**
     * A builder method that invokes the {@link javafx.scene.control.cell.ProgressBarTableCell#setItem(java.lang.Object) setItem} method on the instance being constructed.
     *
     * @return builder instance
     */
     ...
     * This serves as a shorthand form of the {@link #apply(java.util.function.Consumer<javafx.scene.control.cell.ProgressBarTableCell<S>> func) apply} method.
     * <p>
     * Example: 
     * </p>
     * <pre>{@code
